...
const ResourcesSelected = ({ selectedData, setResources, resources }) => {
  ...
  const stopProps = {
    ...
    title: `คุณแน่ใจหรือไม่ที่จะทำการหยุดการทำงานของ Resource ทั้ง ${selectedData.length} รายการดังนี้`,
  ...
  const deleteProps = {
    ...
    title: `คุณแน่ใจหรือไม่ที่จะทำการลบ Resource ทั้ง ${selectedData.length} รายการดังนี้`,

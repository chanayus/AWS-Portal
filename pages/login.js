...
const Container = styled.div`
    ${tw`flex justify-between items-center w-full min-h-screen`}
...
const LoginForm = styled.form`
    ...
    max-width: 550px;
    flex: 1;
    padding: clamp(10px,6vmin,50px) clamp(10px,6vmin,40px);
    background: #FFF;
    transition: 0.25s;
    @media(max-width: 960px){
        max-width: 100%;
        padding: 30vh clamp(10px,6vmin,40px);
    }
    h1{
